...
/*Função para remover elemento de uma folha em uma árvore B*/
Arvore* remover_de_folha (Arvore *a, int index);

/*Função para remover um elemento em um nó na árvore B*/
...
/*Função para remover um elemento de uma árvore B*/
